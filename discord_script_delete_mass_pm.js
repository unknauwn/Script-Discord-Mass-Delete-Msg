...
async function clearMessages() {
	const server = window.location.href.split('/').pop(); // server id number
	...
	let searchURL = `https://discordapp.com/api/v6/channels/${server}/messages/search?author_id=${author}`;

	if (typeof channel !== 'undefined') searchURL = searchURL;
